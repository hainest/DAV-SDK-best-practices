"""
Tests for the BackportActionExists check
"""

from davbp.checks.BackportActionExists import BackportActionExists as backport
...
def test_BackportActionExists():
    """Basic test"""
    for r in test_repos:
        assert backport().run(r["repo"]) == r["status"]


def test_BackportActionExists_wrong_answer():
